...
# prevent prompt for mysql/phpmyadmin
...
create_deploy_group $DEPLOY_GROUP $DEPLOY_DIR $DEPLOY_LOGS $DEPLOY_VIRTUALENVS
create_deploy_user $DEPLOY_USER $DEPLOY_GROUP
[ $DEPLOY_USE_JENKINS == 1 ] && `create_deploy_user $DEPLOY_JENKINS_USER $DEPLOY_GROUP`
